        ...
        <div class="container">
            <div class="post-detail-wrap position-relative w-100">
                <div class="post-detail-img w-100">
                    <img class="img-fluid w-100" src="{{asset("assets/images/about/blog/".$about_blog->image)}} " height="576" width="1024">
                </div>
                <div class="post-detail-desc w-100">
                    <p class="mb-0">{{$about_blog->first_part}}</p>
                    <blockquote>
                        <p class="mb-0">{{$about_blog->second_part}}</p>
                    </blockquote>
                    <p class="mb-0">{{$about_blog->third_part}}</p>
                    <div class="post-detail-gal w-100">
                        <div class="row mrg15">
                            @foreach ( explode(',',$about_blog->photos)  as $key=>$photo)
                                <div class="col-md-4 col-sm-12 col-lg-4">
                                    <div class="post-detail-gal-item position-relative overflow-hidden w-100">
                                        <a href="{{asset("assets/images/about/blog/".$photo)}}" data-fancybox="gal"  ><img class="img-fluid w-100" src="{{asset("assets/images/about/blog/".$photo)}}"  ></a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    <p class="mb-0">{{$about_blog->forth_part}}</p>
                    <p class="mb-0">{{$about_blog->fifth_part}}</p>
                </div>
            </div>
        </div>
    </div>
